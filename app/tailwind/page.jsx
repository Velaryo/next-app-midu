  ...
  return (
    ...
    '
      ...
      <section>
        ...
        <span className='text-red-400'>
          videos con ratio - aspecto responsivo. Si en vez de aspect-video se
          usa aspect-[4/3] o 9/16, etc, se puede manipular para que quede en
          vertical el aspect
        </span>{' '}
        <br />
        {/* <iframe
          className='aspect-video w-full'
          src='https://youtu.be/kKQdMd2v5CA'
        ></iframe> */}
      </section>
      <br />
      <hr />
